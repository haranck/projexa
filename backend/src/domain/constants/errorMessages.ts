...
export const PROJECT_ERRORS = {
    ...
    ONLY_PROJECT_MANAGER_CAN_START_SPRINT: "Only project manager can start sprint",
    ONLY_PROJECT_MANAGER_CAN_CREATE_SPRINT: "Only project manager can create sprint",
    UNAUTHORIZED_TO_CREATE_PROJECT: "Unauthorized to create project in this workspace",
    UNAUTHORIZED_TO_UPDATE_PROJECT: "Unauthorized to update project in this workspace",
    UNAUTHORIZED_TO_ADD_PROJECT_MEMBER: "Unauthorized to add project member",
    UNAUTHORIZED_TO_REMOVE_PROJECT_MEMBER: "Unauthorized to remove project member",
    UNAUTHORIZED_TO_DELETE_PROJECT: "Unauthorized to delete project",
    UNAUTHORIZED_TO_UPDATE_MEMBER_ROLE: "Unauthorized to update project member role",
};
